...
<form id="form" method="post" action="./tupian1.php" onsubmit="return Check();">
<p align = center><br>
<input type="radio" name="radio" value="1"  checked>上传时间
<input type="radio" name="radio" value="2">支付时间<br><br>
