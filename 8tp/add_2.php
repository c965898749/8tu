...
<form class="form-horizontal" role="form" name="form1" method="post" enctype="multipart/form-data" style="margin-top: 30px;" >
	<table width="804" height="200" border="0">
	  ...
	  <tr>
		<td><div align=right style="margin-right: 10px;">打赏前看到的图像</div></td>
		<td width="300">
	  ...
	  <tr>
		<td><div align=right style="margin-right: 10px;">打赏后看到的图像</div></td>
		<td>
			<input type="file" id="upfile2_id" name="upfile2" accept="image/gif,image/jpeg,image/png, image/jpg" >
			<span id="upfile2_text" style="color: red"></span>
		</td>
	  </tr>
	  <tr>
		<td colspan="2">
...
<div class="main-content">
	...
	<table border="0" height="200">
	  ...
	  <tr>
		<td>打赏后看到的图像：</td>
		<td>                    
			<input type="file" id="upfile2_id_m" name="upfile2" accept="image/gif,image/jpeg,image/png, image/jpg" >
                    <span id="upfile2_text_m" style="color: red"></span>
		</td>
	  </tr>
	  <tr>
		<td colspan="2">
...
<script type="text/javascript">
    ...
    function chkForm2(obj){
		...
		if(obj.upfile2.value==""){
            $('#upfile2_text').html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请选择上传图片');
            obj.upfile2.focus();
            return false;}
		if (checkfiletype(obj.upfile1.value, obj.upfile2.value) == false)
		{
			return false;
		}
        return true;
    ...
    //检测图片格式
    function checkfiletype(value1, value2){
        var file = value1;
		...
		var file2 = value2;
        if(!/\.(gif|jpg|jpeg|png|gif|jpg|png)$/i.test(file2)){
            alert("图片类型必须是 gif,jpg,png 中的一种");
            return false;
        }
