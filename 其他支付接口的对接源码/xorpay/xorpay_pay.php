...
ini_set('date.timezone','Asia/Shanghai');
  ...
  if ( isset($config_8tupian['subjectname']) )
  {
	...
	{
?>
	<form name=alipayment action="<?php echo 'weixin.php' ?>" method=post target="_self">
<?php
	}
	else
	{
?>
	<form name=alipayment action="<?php echo 'alipay.php' ?>" method=post target="_self">
<?php
	}
?>
	...
	<input type="hidden" id="WIDsubject" name="WIDsubject"  value="<?php echo $subject; ?>" />
